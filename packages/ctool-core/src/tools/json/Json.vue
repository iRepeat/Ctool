        ...
        <Display position="top-right" class="ctool-page-option" style="margin-top: 5px">
            ...
            >
                <Align>
                    ...
                    />
                    <Dropdown @select="(value)=>general.rename(value)" :placeholder="$t('json_key_rename')" :options="renameTypeLists"/>
                    <span>|</span>
...
// 来自
watch(() => action.current.option.from.serialization, (serialization) => {
